const LEVELS_DATA = [
  {
    ...
    "goal": {
      "expectedColors": ["red", "blue", "red", "blue", "red", "blue"]
    },
    "feedbackProfile": "basic",
    "transferVariant": false,
  ...
  },
  {
    ...
    "goal": {
      "expectedShapes": ["circle", "triangle", "circle", "triangle", "circle", "triangle"]
    },
    "feedbackProfile": "basic",
    "transferVariant": true,
    "hint": "Las señales siguen el mismo tipo de orden que los planetas."
  },
  {
    "id": "level_03",
    ...
    "goal": {
      "expectedColors": ["yellow", "yellow", "purple", "yellow", "yellow", "purple"]
    },
    "feedbackProfile": "basic",
    "transferVariant": true,
